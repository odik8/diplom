...
- [docs/payments.md](docs/payments.md) — интеграция оплаты PayPalych: создание счёта, postback, тестовый режим
- [docs/](docs/) — материалы ВКР: пояснительная записка, презентация, скриншоты экранов
